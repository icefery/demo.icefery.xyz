...
public class NativeSQLConverter {
    ...
    static {
        ...
        VALUE_CONVERTER_MAP.put(LocalDateTime.class, (dialect, value) ->
            datetime(dialect, ((LocalDateTime) value).format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
        );
        VALUE_CONVERTER_MAP.put(XMLGregorianCalendar.class, (dialect, value) ->
            datetime(
                dialect,
