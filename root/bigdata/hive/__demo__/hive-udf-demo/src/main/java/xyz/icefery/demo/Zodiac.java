...
public class Zodiac extends GenericUDF {
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
        ...
        if (!Objects.equals(ObjectInspector.Category.PRIMITIVE, arguments[0].getCategory()) || !((PrimitiveObjectInspector) arguments[0]).getPrimitiveCategory().equals(PrimitiveObjectInspector.PrimitiveCategory.DATE)) {
