...
public class JSONArrayFlat extends GenericUDTF {
    ...
    public StructObjectInspector initialize(ObjectInspector[] argOIs) throws UDFArgumentException {
        ...
        if (
            !Objects.equals(argOIs[0].getCategory(), ObjectInspector.Category.PRIMITIVE) ||
            !Objects.equals(((PrimitiveObjectInspector) argOIs[0]).getPrimitiveCategory(), PrimitiveObjectInspector.PrimitiveCategory.STRING)
        ) {
            throw new UDFArgumentTypeException(0, USAGE);
        }
        return ObjectInspectorFactory.getStandardStructObjectInspector(List.of("item"), List.of(PrimitiveObjectInspectorFactory.javaStringObjectInspector));
    }
