...
public final class FunctionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<generated.FunctionOuterClass.FetchRequest,
      generated.FunctionOuterClass.FetchResponse> getFetchMethod;
  ...
  public static io.grpc.MethodDescriptor<generated.FunctionOuterClass.FetchRequest,
      generated.FunctionOuterClass.FetchResponse> getFetchMethod() {
    ...
    if ((getFetchMethod = FunctionGrpc.getFetchMethod) == null) {
      synchronized (FunctionGrpc.class) {
        if ((getFetchMethod = FunctionGrpc.getFetchMethod) == null) {
          FunctionGrpc.getFetchMethod = getFetchMethod =
              io.grpc.MethodDescriptor.<generated.FunctionOuterClass.FetchRequest, generated.FunctionOuterClass.FetchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "fetch"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.FunctionOuterClass.FetchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.FunctionOuterClass.FetchResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<generated.FunctionOuterClass.InvokeRequest,
      generated.FunctionOuterClass.InvokeResponse> getInvokeMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.FunctionOuterClass.InvokeRequest,
      generated.FunctionOuterClass.InvokeResponse> getInvokeMethod() {
    ...
    if ((getInvokeMethod = FunctionGrpc.getInvokeMethod) == null) {
      synchronized (FunctionGrpc.class) {
        if ((getInvokeMethod = FunctionGrpc.getInvokeMethod) == null) {
          FunctionGrpc.getInvokeMethod = getInvokeMethod =
              io.grpc.MethodDescriptor.<generated.FunctionOuterClass.InvokeRequest, generated.FunctionOuterClass.InvokeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "invoke"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.FunctionOuterClass.InvokeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.FunctionOuterClass.InvokeResponse.getDefaultInstance()))
  ...
  public static FunctionStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FunctionStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<FunctionStub>() {
        @java.lang.Override
   ...
   */
  public static FunctionBlockingStub newBlockingStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FunctionBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<FunctionBlockingStub>() {
        @java.lang.Override
   ...
   */
  public static FunctionFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FunctionFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<FunctionFutureStub>() {
        @java.lang.Override
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void fetch(generated.FunctionOuterClass.FetchRequest request,
    ...
    /**
     */
    default void invoke(generated.FunctionOuterClass.InvokeRequest request,
   ...
   */
  public static abstract class FunctionImplBase
   ...
   */
  public static final class FunctionStub
      extends io.grpc.stub.AbstractAsyncStub<FunctionStub> {
    ...
    /**
     */
    public void fetch(generated.FunctionOuterClass.FetchRequest request,
        io.grpc.stub.StreamObserver<generated.FunctionOuterClass.FetchResponse> responseObserver) {
    ...
    /**
     */
    public void invoke(generated.FunctionOuterClass.InvokeRequest request,
        io.grpc.stub.StreamObserver<generated.FunctionOuterClass.InvokeResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
   ...
   */
  public static final class FunctionBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<FunctionBlockingStub> {
    private FunctionBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected FunctionBlockingStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new FunctionBlockingStub(channel, callOptions);
    }
   ...
   */
  public static final class FunctionFutureStub
      extends io.grpc.stub.AbstractFutureStub<FunctionFutureStub> {
    private FunctionFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected FunctionFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new FunctionFutureStub(channel, callOptions);
    }
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FETCH:
          serviceImpl.fetch((generated.FunctionOuterClass.FetchRequest) request,
              (io.grpc.stub.StreamObserver<generated.FunctionOuterClass.FetchResponse>) responseObserver);
          break;
        case METHODID_INVOKE:
          serviceImpl.invoke((generated.FunctionOuterClass.InvokeRequest) request,
              (io.grpc.stub.StreamObserver<generated.FunctionOuterClass.InvokeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class FunctionBaseDescriptorSupplier
  ...
  private static final class FunctionFileDescriptorSupplier
