...
public class Book extends TableImpl<BookRecord> {
    ...
    /**
     * Get the implicit join path to the <code>test.author</code> table.
     */
    public Author author() {
        if (_author == null) _author = new Author(this, Keys.BOOK__FK_BOOK_AUTHOR);

        return _author;
    }

    /**
     * Get the implicit join path to the <code>test.language</code> table.
     */
    public Language language() {
        if (_language == null) _language = new Language(this, Keys.BOOK__FK_BOOK_LANGUAGE);
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function5<? super Integer, ? super Integer, ? super String, ? super Integer, ? super Integer, ? extends U> from
    ) {
