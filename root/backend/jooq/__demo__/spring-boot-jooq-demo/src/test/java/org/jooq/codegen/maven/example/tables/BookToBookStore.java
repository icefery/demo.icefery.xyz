...
public class BookToBookStore extends TableImpl<BookToBookStoreRecord> {
    ...
    /**
     * Get the implicit join path to the <code>test.book_store</code> table.
     */
    public BookStore bookStore() {
        if (_bookStore == null) _bookStore = new BookStore(this, Keys.BOOK_TO_BOOK_STORE__FK_B2BS_BOOK_STORE);

        return _bookStore;
    }

    /**
     * Get the implicit join path to the <code>test.book</code> table.
     */
    public Book book() {
        if (_book == null) _book = new Book(this, Keys.BOOK_TO_BOOK_STORE__FK_B2BS_BOOK);
