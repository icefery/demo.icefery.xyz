#include "stdio.h" /*问1、这个头文件的作用是什么？？*/   // TODO: IO 相关库
#include "stdlib.h" /*问2、这个头文件的作用是什么？？*/  // TODO: malloc 函数

//问3、以下是什么内容的定义？              // TODO: 文件索引结构
struct index {
    int lr[32]; /*问4、lr是什么？*/     // TODO: 逻辑号
    int pr[32]; /*问5、pr是什么？*/     // TODO: 物理号
    char st[32];
} * wq;
#define JOBN 20  //问6、本句的作用是什么？// TODO: 宏替换（定义）模拟时输入的文件数量

//问7、以下是什么内容的定义？              // TODO: 文件目录结构、与 index 一起构成规划文件信息的数据结构
struct list {
    char names[32];
    int size[32];
...
/*问8、fenpei函数的作用是什么？根据以下代码和注释分析，请在实验报告中画出fenpei函数流程图*/  // TODO: 为文件分配空间
void fenpei() {
    int x1, y, z;
...
/*9、请将程序运行结果截图*/                 // TODO: 1
/*10、请问结果文件的名字以及保存位置？*/      // TODO: 绝对路径：d:/result.txt
/*11、请对照代码对结果文件的内容加以分析*/    // TODO: 1
int main() {
    int k;
    e = fopen("c:/results.txt", "w");
    for (j = 0; j < 4; j++)
        for (i = 0; i < 8; i++) J[j][i] = 0;  //初始化位图
    ...
    printf("\n");
    int kk = 0;
    //问12、以下输入的是什么？请问这些信息保存在哪个数据结构中？    // TODO: 基本文件信息；保存在作业序列 job[JOBN] 中
    while (kk < jobs) {
        fprintf(e, "FILE %d: \n", kk);
        printf("FILE %d: \n", kk);
    ...
    for (k = 1; k <= jobs; k++) fenpei();  //每个文件进行一次分配

    //问13、以下4行代码的作用是什么？                          // TODO: 释放模拟文件系统时申请的内存
    fclose(e);
    for (i = 0; i < 32; i++) {
        free(HEAD->p[i]);
        HEAD->p[i] = NULL;
